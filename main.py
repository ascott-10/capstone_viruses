...
print(f"Trained on: {len(train_dataset)} images")  # update if classifier uses a different dataset
print(f"Final Test Accuracy (from stats): {X_test_df_preds['correct'].sum() / len(X_test_df_preds) * 100:.2f}%")
